...
== Credit where credit's due
	...
	Thank's to {James W. Thompson, II}[http://github.com/jwthompson2], there's now support for all of the standard video and audio options from
	the ffmpeg documentation as well improved and refactored specs.